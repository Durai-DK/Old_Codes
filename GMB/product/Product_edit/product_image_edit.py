...
# image = r"D:\Durai\GMB\product\image\02-09-2022.jpeg"
            ...
            for r2 in r1.find_elements(By.CLASS_NAME,'TB4jmc'):
                for r3 in r2.find_elements(By.CLASS_NAME,"bgmvLc"):
                    ...
                    if r3.text == "Samsung Galaxy Z Flip 4 5G":
                        ...
                        driver.find_element(By.CLASS_NAME, "ULhCdf").send_keys(r"D:\Durai\GMB\product\image\02-09-2022.jpeg")
                        time.sleep(5)
