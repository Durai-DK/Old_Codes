        ...
        for r1 in driver.find_elements(By.CLASS_NAME,'zTXfQc'):
            for r2 in r1.find_elements(By.CLASS_NAME,'TB4jmc'):
                for r3 in r2.find_elements(By.CLASS_NAME,"bgmvLc"):
                    # print(r3.text)
                    if r3.text == "Listen Anywhere, Anytime. Speakers @10%* Inst. Off":
                        r2.click()
                        time.sleep(3)

                        # driver.implicitly_wait(10)
                        driver.find_element(By.CLASS_NAME, "ULhCdf").send_keys(r"D:\Durai\GMB\product\image\10-01-2023-edit.jpeg")
                        time.sleep(3)
